    ...
    <footer className="footer">
      <div className="container footer__container">
        <a className="footer__logo-link">
          <img className="footer__logo" src="image/logo.svg" alt="Логотип Cuo Time"/>
        </a>
        
        <div className="footer__nav">
            <ul className="footer__menu">
              <li className="footer__minu-item">
        ...
        <div className="footer__info">
          ...
          <ul className="footer__developers">
            ...
            <li className="footer__developer">Developer:
              <a className="footer__developer-link" href="#">Khlopov Dmitriy</a>
            </li>
          </ul>
        </div>
